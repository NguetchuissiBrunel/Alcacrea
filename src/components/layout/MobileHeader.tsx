...
export function MobileHeader() {
  ...
  return (
    <header className="md:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-3 bg-ink-soft/95 backdrop-blur-md border-b border-vellum/8">
      <Link
        to="/"
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <span className="font-mono text-[10px] text-breath font-medium">SM</span>
        </Link>
      </div>
    </header>
  )
